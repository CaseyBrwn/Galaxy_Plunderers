...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const game = new GameCanvas(canvas, ctx, ProjectileHandler, Plunderers, Barriers, SpaceShip, startscreen, Starfield, Starfieldpic, SpaceShippic, alienspic, Counter, soundObject, PowerUps)
